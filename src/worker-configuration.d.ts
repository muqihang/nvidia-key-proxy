/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: ba738024ea74bc688719d1baeb604df6)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	KEY_MAPPINGS: KVNamespace;
	USAGE_COUNTERS: DurableObjectNamespace<import("./index").UsageCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "UsageCounter";
	}
